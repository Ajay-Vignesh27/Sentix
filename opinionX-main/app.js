/**
 * opinionX Main Application Controller
 */
...
function getHistory() {
  try {
    const raw = localStorage.getItem('opinionX_history');
...
function saveBatchToHistory(id, name, data) {
  try {
    ...
    localStorage.setItem('opinionX_history', JSON.stringify(history));
  } catch (e) {
...
function initTheme() {
  ...
  const savedTheme = localStorage.getItem('opinionX_theme') || 'light';
...
function toggleTheme() {
  ...
  if (isDark) {
    localStorage.setItem('opinionX_theme', 'dark');
    toggleBtn.innerHTML = '<i class="ti ti-sun" aria-hidden="true"></i>';
    toggleBtn.setAttribute('aria-label', 'Switch to Light Theme');
    showToast('Switched to Dark Theme.');
  } else {
    localStorage.setItem('opinionX_theme', 'light');
    toggleBtn.innerHTML = '<i class="ti ti-moon" aria-hidden="true"></i>';
    toggleBtn.setAttribute('aria-label', 'Switch to Dark Theme');
